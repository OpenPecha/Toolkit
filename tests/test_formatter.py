...
class TestHFMLFormatter:
    ...
    def test_build_layers(self):
        ...
        expected_result = {
            ...
            'topic': [[(0, 2173, 1,'T1')],[(0, 266, 2,'T2'),(0,26,3,'T2')], [(26, 242, 3,'T3')],[(242,266,3,'T4')]],
            'sub_topic': [[[(0, 1352, 1,'T1-1')], [(1353, 1496, 1,'T1-2')], [(1497, 2173, 1,'T1-6')]], [[(0, 140, 2,'T1-8')],[(141,266,2,'T1-9'),(0,26,3,'T1-9')]],[[]],[[]]],
