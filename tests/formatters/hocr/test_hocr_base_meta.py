...
def test_google_ocr_base_meta():
    ...
    expected_meta_path = Path(__file__).parent / "data" / "opf_expected_datas" / "expected_hocr_meta.yml"
    ...
    bdrc_image_list_path = Path(__file__).parent / "data" / work_id / "google_books" / "batch_2022" / "output"
